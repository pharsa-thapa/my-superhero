...
export default function SuperheroCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPowerstats(initialValues.powerstats);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Superhero(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SuperheroCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
